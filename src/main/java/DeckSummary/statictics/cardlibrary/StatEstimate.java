...
public class StatEstimate {
    ...
    public static class Deserializer implements JsonDeserializer<StatEstimate> {
        @Override
        // The stat estimate can be serialised on two main ways to make entering values easier.
        // First, it can be represented by a singular StatValue, which will be deserialised as a StatValue and copied
        ...
        // case it will be deserialised as a StatEstimate object directly.
        public StatEstimate deserialize(JsonElement jsonElement, Type _type, JsonDeserializationContext context)
            ...
            if (jsonElement.isJsonObject()) {
                ...
                // StatEstimate and deserialised directly.
            ...
            // Otherwise it will be deserialised as a StatValue
